 ...
 * @author    #1302313 <email@example.com>
 * @license   GPL-2.0+
 * @link      http://redacademy.com
 * @copyright 2019 Inhabitent, RED Academy
 *
 * @wordpress-plugin
 * Plugin Name:       Inhabitent Business Hours Widget
 * Plugin URI:        http://www.github.com/1302313
 * Description:       Widget created to display business hours
 * Version:           1.0.0
 * Author:            AEN
 * Author URI:        http://www.github.com/1302313
 * License:           GPL-2.0+
...
class Tent_Biz_Hours extends WP_Widget
{
	...
	/**
	 * @TODO - Rename "widget-name" to the name your widget
	 *
	...
	public function __construct()
	{
		...
		parent::__construct(
			...
			array(
				...
				'description' => 'Add store business hour.'
			)
		);
	} // end constructor
...
add_action('widgets_init', function () {
	...
	add_shortcode('widget', 'Tent_Biz_Hours');
});
